...
export interface paths {
  ...
  '/work-sessions': {
    ...
    get: {
      ...
      responses: {
        200: {
          ...
          content: {
            'application/json': components['schemas']['WorkSessionRow'][];
          };
        };
        /** @description Error */
        400: {
    ...
    post: {
      ...
      requestBody: {
        content: {
          'application/json': components['schemas']['StartWorkSession'];
        };
      };
      responses: {
        /**
  ...
  '/work-sessions/{id}/progress': {
    ...
    post: {
      ...
      requestBody: {
        content: {
          'application/json': components['schemas']['RecordWorkSessionProgress'];
        };
      };
      responses: {
        200: {
          ...
          content: {
            'application/json': components['schemas']['WorkSessionProgressResult'];
          };
        };
        /** @description Error */
        400: {
  ...
  '/work-sessions/{id}/attach': {
    ...
    post: {
      ...
      requestBody: {
        content: {
          'application/json': components['schemas']['AttachWorkSession'];
        };
      };
      responses: {
        /**
  ...
  '/work-sessions/{id}/convert': {
    ...
    post: {
      ...
      requestBody: {
        content: {
          'application/json': components['schemas']['ConvertWorkSession'];
        };
      };
      responses: {
        200: {
...
export interface components {
  schemas: {
    ...
    WorkSessionProgressResult: {
      ...
      work_session: components['schemas']['WorkSessionRow'];
    };
    /**
     * @description A top-level work session. It may be linked to a task, or it may be a
     *     standalone session that is later converted into a task.
    ...
    CapabilityRequest: {
       ...
       */
      input_path?: components['schemas']['InputPath'] | null;
      note?: string | null;
      /** Format: int64 */
      quantity_done?: number | null;
      /**
