...
7. When the user wants to pause or has no more to say, ask "今日はここまでにしますか？" If yes, record a `coverage_confirm` for today with `source: "intake_complete"` and stop. Do not record coverage if any part of the batch was not committed.
